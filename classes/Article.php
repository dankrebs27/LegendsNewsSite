...
class Article
{
  ...
  */
  ...
  public static function getById( $id ) {
	...
	//Get list of most recent articles
   public static function getList( $numRows=1000000, $order="publicationDate DESC" ) {
	...
	//Get list of most recent articles by position entered
  public static function getByPoisition( $position, $numRows=1000000, $order="publicationDate DESC" ) {
    $conn = new PDO( DB_DSN, DB_USERNAME, DB_PASSWORD );
    $sql = "SELECT SQL_CALC_FOUND_ROWS *, UNIX_TIMESTAMP(publicationDate) AS publicationDate 
			FROM articles 
